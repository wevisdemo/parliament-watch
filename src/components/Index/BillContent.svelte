<script lang="ts">
	...
	async function loadBills(selectedCategory?: string) {
		isLoading = true;
				...
				bills: {
					__args: {
						...(selectedCategory
							? {
									where: {
										categories_INCLUDES: selectedCategory
									}
								}
							: {}),
...
<div class="relative flex flex-col gap-6">
	...
	<div class="flex flex-col gap-2 md:flex-row">
		...
		<div class="flex flex-row flex-wrap items-center gap-1">
			{#each [ALL_CATEGORY_KEY, ...billCategories] as category}
				<button
