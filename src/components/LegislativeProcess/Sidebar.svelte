	...
	let sections = [
		{
			menu: 'แนะนำภาพรวม',
			menuItem: [
				{ text: 'กฎหมายสำเร็จได้อย่างไร' },
				{ text: 'กฎหมายในเว็บไซต์นี้' },
				{ text: 'ประเภทของกฎหมาย' },
				{ text: 'สถานะของกฎหมาย' }
			]
		},
		{
			menu: 'ขั้นตอนของกฎหมาย',
			menuItem: [
				{ text: 'ที่มาของกฎหมาย' },
				{ text: 'ขั้นตอนโดยย่อ' },
				{ text: 'ขั้นตอนโดยละเอียด' }
			]
		},
		{
			menu: 'ประเภทการลงมติ',
			menuItem: [{ text: 'ประเภทของมติ' }, { text: 'ผลของการลงมติ' }, { text: 'การลงมติอื่นๆ' }]
		},
		{
			menu: 'ส.ส. และ ส.ว. ทำอะไรบ้างในสภา',
			menuItem: [
				{ text: 'หน้าที่ขออง ส.ส.' },
				{ text: 'หน้าที่ของ ส.ว.' },
...
<SideNav isOpen={true} fixed={false} class="relative">
	<SideNavItems>
