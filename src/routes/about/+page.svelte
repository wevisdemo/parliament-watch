	...
	<div bind:this={contentContainer} class="body-02 flex-1 px-4 md:px-16">
		...
		<section class="flex flex-col gap-2 py-6 md:py-9">
			...
			<p>
				...
				ภายใต้เงื่อนไข Creative Commons Attribution-NonCommercial-ShareAlike License
		...
		<section class="flex flex-col gap-2 py-6 md:py-9">
			...
			<p>
				...
				ภารกิจของเราคือการทำให้ประชาธิปไตยไทยเปิดเผย โปร่งใส และมีส่วนรวมได้
			</p>
			<p>
			...
			<p>
				...
				โดยแจ้งความประสงค์ร่วมพัฒนาโปรเจกต์ ส่งความคิดเห็น เสนอไอเดีย แจ้งเปลี่ยน / อัพเดตข้อมูล
