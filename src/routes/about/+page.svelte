<script lang="ts">
	...
	const sections = [
		...
		{
			menu: 'เกี่ยวกับข้อมูลในเว็บไซต์',
			menuItem: [
				{ text: 'ที่มาและข้อจำกัดข้อมูล' },
				{ text: 'กระบวนการจัดทำข้อมูล' },
				{ text: 'นโยบายการนำข้อมูลไปใช้ต่อ' }
			]
		},
		{
...
<div class="flex flex-col md:flex-row">
	...
	<div bind:this={contentContainer} class="body-02 flex-1 px-4 md:px-16">
		...
		<section class="flex flex-col gap-2 py-6 md:py-9">
			...
			<ul class="list-disc">
				<li>
					<strong>การลงมติ:</strong> มาจากเอกสารบันทึกการออกเสียงและลงคะแนน (ใบประมวลผลการลงมติ)
					ในเว็บไซต์
					<a
			...
			<p>
				ข้อมูลทั้งหมดภายในเว็บไซต์ถูกรวบจากช่องทางต่างๆ ภายใต้ข้อจำกัดในหลายๆ ด้านตามที่กล่าวด้านบน
				ทาง WeVis ไม่สามารถรับผิดชอบต่อผลกระทบใดๆ
			</p>
		</section>
		<section class="flex flex-col gap-2 py-6 md:py-9">
			...
			<p>
				...
				หรือมีข้อสงสัยอยากสอบถาม ได้ทาง feedback form หรือ GitHub repository ข้างล่างนี้
