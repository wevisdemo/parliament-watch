			...
			<section>
				...
				<div>
					...
					<ol class="list-decimal list-inside body-02 mt-6">
						<li>
							<b>การเสนอร่างกฎหมาย</b> เป็นการจัดทำร่างกฎหมายและเสนอเข้าสู่รัฐสภา โดยผู้ที่มีสิทธิเสนอร่างกฎหมายจะแตกต่างกันขึ้นอยู่กับว่าเป็นร่างกฎหมายประเภทใดตามที่รัฐธรรมนูญระบุไว้
			...
			<section>
				...
				<div>
					...
					<p>
						...
						กระบวนการออกกฎหมายโดยรัฐสภา อย่างเช่นการออก พรบ.หรือการอนุมัติ พรก.จะดำเนินการผ่าน <b
							>5 ขั้นตอน</b
						>ดังต่อไปนี้
					</p>
					...
					<div>
						...
						<div class="gray-box">
							...
							<p class="body-02">
								สว.<b class="heading-02">ไม่มีอำนาจ ‘ปัดตก’</b> หรือทำให้ร่างกฎหมายที่
								สส.มีมติเห็นชอบแล้วหายไปได้ แต่ สว.<b class="heading-02">สามารถเพิ่มขั้นตอน</b
				...
				<div class="mb-6">
					...
					<div class="mt-10 body-02">
						...
						<p>
							ขั้นตอนในการพิจารณาร่าง พรป.จะดำเนินในรูปแบบเดียวกันกับการออก พรบ.เว้นแต่ใน<b
								>เงื่อนไขเพิ่มเติม</b
							>ต่อไปนี้
						</p>
						<img
							...
							<li class="mb-2">
								...
								<ul class="list-disc list-outside ml-8">
									...
									<li>
										...
										จากนั้นให้รัฐสภาดําเนินการต่อไปในวิธีการเดียวกันกับการตรา พรบ.
									</li>
								</ul>
							</li>
						</ol>
					...
					<div class="mt-10 body-02">
						...
						<p>
							...
							เช่นเดียวกันกับการออก พรบ.แต่ปรากฏ<b>เงื่อนไขเพิ่มเติม</b>ดังนี้
						</p>
						<img
							class="my-4 mx-auto w-full max-w-[440px]"
						...
						<ol class="list-decimal list-outside gap-2 ml-6">
							...
							<li class="mb-2">
								...
								<ul class="list-disc list-outside ml-8">
									...
									<li>เสียงเห็นชอบจาก สว.ไม่น้อยกว่า <b>1 ใน 3 ของจำนวน สว.</b></li>
									<li>
										เสียงเห็นชอบ สส.จากพรรคที่ไม่มีสมาชิกเป็นรัฐมนตรี ประธานสภาหรือรองประธานผู้แทนฯ
										หรือ <b>‘สส.ฝ่ายค้าน’ ไม่น้อยกว่าร้อยละ 20</b>
