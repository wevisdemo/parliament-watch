	...
	<main class="flex flex-col justify-center md:flex-row items-center md:items-start">
		...
		>
			<section>
				...
				<div>
					...
					<p class="body-02 mt-6">
						...
						เพราะเป็นตัวแทนของประชาชนในการทำหน้าที่และใช้อำนาจนิติบัญญัติ
						การออกกฎหมายต้องดำเนินตามกระบวนการที่ระบุไว้ในรัฐธรรมนูญ 2560 ซึ่งกฎหมายมีหลายประเภท
						กฎหมายประเภทหนึ่งอาจมีกระบวนการ ลำดับขั้น
						หรือเงื่อนไขในการพิจารณาที่แตกต่างไปจากกฎหมายอีกประเภทหนึ่ง
						ด้วยเหตุเพราะกฎหมายแต่ละประเภทมีลำดับชั้นที่แตกต่างกัน
						การกำหนดลำดับชั้นระหว่างกฎหมายประเภทต่าง ๆ มีขึ้นเพื่อให้กฎหมายแม่บท อย่าง ‘รัฐธรรมนูญ’
						เป็นตัวกำกับกฎหมายที่อยู่ในลำดับชั้นรองลงมา เช่น พระราชบัญญัติ
						ซึ่งต้องห้ามขัดหรือแย้งต่อกฎหมายสูงสุดอย่างรัฐธรรมนูญ
			...
			<section>
				...
				<div>
					<h2 class="fluid-heading-04" id="ขั้นตอนโดยย่อ">ขั้นตอนทั่วไป</h2>
					<hr />
				</div>
				<div>
